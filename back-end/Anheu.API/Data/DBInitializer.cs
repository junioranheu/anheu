...
namespace Anheu.API.Data
{
    public static class DbInitializer
    {
        ...
        public static void Seed(Context context)
        {
            ...
            {
                context.Aulas.Add(new Aula() { AulaId = 1, DisciplinaId = 1, Nome = "HTML e CSS", Thumbnail = "aulas/thumbnail/1.webp", Video = "aulas/video/1.mp4", Professor = "Mariana Scalzaretto", ResumoAula = "#1 - Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante.", DataRegistro = dataAgora, IsAtivo = 1 });
                context.Aulas.Add(new Aula() { AulaId = 2, DisciplinaId = 1, Nome = "SLLW?", Thumbnail = "aulas/thumbnail/2.webp", Video = "aulas/video/2.mp4", Professor = "Mariana Scalzaretto", ResumoAula = "#2 - Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante.", DataRegistro = dataAgora, IsAtivo = 1 });
                context.Aulas.Add(new Aula() { AulaId = 3, DisciplinaId = 1, Nome = "Khaaa...", Thumbnail = "aulas/thumbnail/3.webp", Video = "/padrao/video/3.mp4", Professor = "Mariana Scalzaretto", ResumoAula = "#3 - Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante.", DataRegistro = dataAgora, IsAtivo = 1 });

                context.Aulas.Add(new Aula() { AulaId = 4, DisciplinaId = 2, Nome = "Trabalhando e relaxando", Thumbnail = "aulas/thumbnail/4.webp", Video = "aulas/video/4.mp4", Professor = "Jackson", ResumoAula = "#4 - Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante.",DataRegistro = dataAgora, IsAtivo = 1 });
                context.Aulas.Add(new Aula() { AulaId = 5, DisciplinaId = 2, Nome = "JS", Thumbnail = "aulas/thumbnail/5.webp", Video = "aulas/video/5.mp4", Professor = "Jackson", ResumoAula = "#5 - Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante.",  DataRegistro = dataAgora, IsAtivo = 1 });

                context.Aulas.Add(new Aula() { AulaId = 6, DisciplinaId = 3, Nome = "Tornando-se um mictor", Thumbnail = "aulas/thumbnail/6.webp", Video = "aulas/video/6.mp4", Professor = "Mariana Scalzaretto", ResumoAula = "#6 - Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante.", DataRegistro = dataAgora, IsAtivo = 1 });
                context.Aulas.Add(new Aula() { AulaId = 7, DisciplinaId = 3, Nome = "Como ser um perdigato?", Thumbnail = "aulas/thumbnail/7.webp", Video = "aulas/video/7.mp4", Professor = "Mariana Scalzaretto", ResumoAula = "#7 - Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante.", DataRegistro = dataAgora, IsAtivo = 1 });
                context.Aulas.Add(new Aula() { AulaId = 8, DisciplinaId = 3, Nome = "Kapa & kapas", Thumbnail = "aulas/thumbnail/8.webp", Video = "aulas/video/8.mp4", Professor = "Mariana Scalzaretto", ResumoAula = "#8 - Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante.", DataRegistro = dataAgora, IsAtivo = 1 });
            }
