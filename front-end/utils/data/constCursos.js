...
const ENDPOINTS = {
    ...
    GET_POR_CURSO_CATEGORIA_ID: 'api/porCursoCategoriaId'
};
...
const DEV = {
    ...
    API_URL_GET_POR_CURSO_CATEGORIA_ID: `${API_BASE_URL_DEV}/${GET_POR_CURSO_CATEGORIA_ID.GET_POR_ID}`
};
...
const PROD = {
    ...
    API_URL_GET_POR_CURSO_CATEGORIA_ID: `${API_BASE_URL_PROD}/${GET_POR_CURSO_CATEGORIA_ID.GET_POR_ID}`
};
