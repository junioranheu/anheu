...
const ENDPOINTS = {
    ...
    GET_ULTIMO_POST: 'api/Posts/getUltimoPost',
};
...
const DEV = {
    ...
    API_URL_GET_ULTIMO_POST: `${API_BASE_URL_DEV}/${ENDPOINTS.GET_ULTIMO_POST}`
};
...
const PROD = {
    ...
    API_URL_GET_ULTIMO_POST: `${API_BASE_URL_PROD}/${ENDPOINTS.GET_ULTIMO_POST}`
};
